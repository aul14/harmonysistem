...
<div class="wrap-table-shopping-cart bgwhite">
    ...
    <table class="table-shopping-cart">
        ...
        <tr class="table-row">
            ...
            <td class="column-6 p-l-20 size11 trans-0-4">
                <button type="submit" name="update" class="flex-c-m col-8 bg1 bo-rad-23 hov1 s-text1 trans-0-4">
                    <i class="fa fa-edit"></i>&nbsp; Update
                </button>
                <br>
                <a href="<?=  base_url('belanja/hapus/'.$keranjang['rowid']) ?>" type="submit" name="hapus" class="flex-c-m col-8 bg1 bo-rad-23 hov1 s-text1 trans-0-4">
...
<div class="size10 trans-0-4 m-t-10 m-b-10">
    <!-- Button -->
    <a href="<?= base_url('belanja/hapus_semua') ?>" class="flex-c-m sizefull bg1 bo-rad-23 hov1 s-text1 trans-0-4">
        Hapus Belanja
    </a>
</div>
</div>
